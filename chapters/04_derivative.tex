...
\begin{proof}
    ...
    \begin{equation*}
        ...
        \left( 1 - \frac{f(c+\delta_1)}{g(x)} \right)
        <
    ...
    which leads to:
    \begin{equation*}
        L - \frac{\varepsilon}{2} - L \frac{f(c+\delta_1)}{g(x)} + \frac{\varepsilon}{2}\frac{f(c+\delta_1)}{g(x)}
        <
        \frac{f(c+\delta_1) - f(x)}{g(x)}
        <
        L + \frac{\varepsilon}{2} - L \frac{f(c+\delta_1)}{g(x)} - \frac{\varepsilon}{2}\frac{f(c+\delta_1)}{g(x)}
    \end{equation*}
    \begin{equation*}
        L - \frac{\varepsilon}{2} + \frac{f(c + \delta_1)}{}
    \end{equation*}
\end{proof}
